          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-10 mb-12">
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="flex items-center gap-2 text-sm text-white/60 hover:text-green-400 transition-colors duration-300 group"
              >
                ...
                <span className="text-xs font-medium tracking-wide">+201509999283</span>
              </a>
            </div>
          </div>
