          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-center">
            ...
            <div className="flex items-center gap-3 text-xs text-white/40">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-1.5 text-white/40 hover:text-green-400 transition-colors duration-300"
              >
                ...
                <span className="text-xs font-medium">01509999283</span>
              </a>
            </div>
          </div>
        </div>
